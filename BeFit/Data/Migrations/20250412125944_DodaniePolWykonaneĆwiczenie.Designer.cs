...
namespace BeFit.Data.Migrations
{
    ...
    [Migration("20250412125944_DodaniePolWykonaneĆwiczenie")]
    partial class DodaniePolWykonaneĆwiczenie
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeFit.Models.SesjaTreningowa", b =>
                {
                    ...
                    b.Property<string>("IdUżytkownika")
                        .IsRequired()
            ...
            modelBuilder.Entity("BeFit.Models.TypĆwiczenia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BeFit.Models.Użytkownik", b =>
                {
            ...
            modelBuilder.Entity("BeFit.Models.WykonaneĆwiczenie", b =>
                {
                    ...
                    b.Property<int>("IdTypuĆwiczenia")
                        .HasColumnType("int");

                    b.Property<int>("LiczbaSerii")
                        .HasColumnType("int");

                    b.Property<double>("Obciążenie")
                        .HasColumnType("float");

                    b.Property<int>("Powtórzenia")
                        .HasColumnType("int");

                    b.Property<int>("SesjaTreningowaId")
                        .HasColumnType("int");

                    b.Property<int>("TypĆwiczeniaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TypĆwiczeniaId");

                    b.ToTable("WykonaneĆwiczenia");
                });
            ...
            modelBuilder.Entity("BeFit.Models.WykonaneĆwiczenie", b =>
                {
                    b.HasOne("BeFit.Models.SesjaTreningowa", "SesjaTreningowa")
                        .WithMany("WykonaneĆwiczenia")
                        .HasForeignKey("SesjaTreningowaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BeFit.Models.TypĆwiczenia", "TypĆwiczenia")
                        .WithMany()
                        .HasForeignKey("TypĆwiczeniaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SesjaTreningowa");

                    b.Navigation("TypĆwiczenia");
                });
            ...
            modelBuilder.Entity("BeFit.Models.SesjaTreningowa", b =>
                {
                    b.Navigation("WykonaneĆwiczenia");
                });

            modelBuilder.Entity("BeFit.Models.Użytkownik", b =>
                {
                    b.Navigation("SesjeTreningowe");
                });
